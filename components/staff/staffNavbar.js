  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          {/* Staff Badge with subtle glowing border and semi-transparent interior */}
          <div style={{
            display: 'flex',
            alignItems: 'center',
            gap: '0.5rem',
            ...
            backdropFilter: 'blur(4px)', /* Adds a slight blur effect for glassmorphism */
            border: '1px solid rgba(255, 255, 255, 0.95)',
            marginRight: '0.5rem',
            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.1), 0 0 12px rgba(255, 255, 255, 0.5)', /* Subtle border glow */
            position: 'relative'
          }}>
            ...
            {/* Very subtle inner shine - optional, can remove if you want */}
            <div style={{
              position: 'absolute',
              top: 0,
              left: '10%',
