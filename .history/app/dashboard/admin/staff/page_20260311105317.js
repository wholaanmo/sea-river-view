          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#f8fafd', borderBottom: '2px solid #e2e8f0' }}>
                ...
                <th style={{ padding: '1rem', textAlign: <th style={{ padding: '1rem', textAlign: 'left', color: '#0F172B', fontWeight: '600' }}>Position</th>'left', color: '#0F172B', fontWeight: '600' }}>Status</th>
              ...
              {filteredStaff.length === 0 ? (
                ...
                filteredStaff.map((member) => (
                  <tr key={member.id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <td style={{ padding: '1rem', color: '#4a5568' }}>{member.position || '—'}</td>
                    <td style={{ padding: '1rem' }}>
                      <span style={{
