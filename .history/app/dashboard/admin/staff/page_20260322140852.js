...
export default function StaffManagement() {
  ...
  const handleAddStaff = async (e) => {
    ...
    try {
      ...
      showNotification('Staff account created successfully! Verification email sent.');
      resetForm();
      fetchStaff();
  ...
  return (
    <div className="p-8 bg-gradient-to-br from-[#F5F9FF] to-[#EFF6FF] min-h-screen">
      {/* Header */}
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#0F172B] font-playfair mb-1">
            Staff Management
          </h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#00B8DB] to-[#0095b3] text-white rounded-xl font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
        >
      ...
      {/* Notification - Upper Right Corner */}
      {notification.show && (
        <div className={`fixed top-5 right-5 z-50 px-5 py-3 rounded-xl shadow-lg flex items-center gap-3 animate-slideInRight ${
      ...
      <div className="flex gap-4 mb-6 flex-wrap">
        <div className="flex-1 min-w-[250px]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300 bg-white"
            />
          </div>
        </div>
        ...
        <select
          ...
          className="px-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 focus:outline-none focus:border-[#00B8DB] cursor-pointer bg-white"
        >
      ...
      {loading ? (
        <div className="flex justify-center items-center h-48">
          <i className="fas fa-spinner fa-spin text-3xl text-[#00B8DB]"></i>
        </div>
      ) : (
                  ...
                  <tr key={member.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${
                        member.role === 'admin' 
                          ? 'bg-[#00B8DB]/10 text-[#00B8DB] border border-[#00B8DB]/30' 
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="p-2 rounded-lg border border-gray-200 bg-white text-gray-600 hover:bg-gray-100 hover:border-gray-300 transition-all duration-200"
                        ...
                        {member.role === 'staff' ? (
                          <button
                            ...
                            className="p-2 rounded-lg border border-gray-200 bg-white text-[#00B8DB] hover:bg-[#00B8DB] hover:text-white hover:border-[#00B8DB] transition-all duration-200"
                            title="Promote to Admin"
                          >
                          ...
                          <button
                            ...
                            className="p-2 rounded-lg border border-gray-200 bg-white text-[#164A6E] hover:bg-[#164A6E] hover:text-white hover:border-[#164A6E] transition-all duration-200"
                            title="Demote to Staff"
                          >
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg border border-gray-200 bg-white text-[#2C5A6E] hover:bg-[#2C5A6E] hover:text-white hover:border-[#2C5A6E] transition-all duration-200"
          ...
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-auto p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-5">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-700 transition-all duration-200 flex items-center justify-center"
              >
            ...
            {modalType === 'add' ? (
              <form onSubmit={handleAddStaff}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2.5 border ${formErrors.name ? 'border-red-500' : 'border-gray-200'} rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300`}
                  />
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-3 py-2.5 border ${formErrors.email ? 'border-red-500' : 'border-gray-200'} rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300`}
                  />
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2.5 pr-10 border ${formErrors.password ? 'border-red-500' : 'border-gray-200'} rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300`}
                    />
                    <button
                      type="button"
                      onClick={togglePasswordVisibility}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#00B8DB] transition-colors"
                    >
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2.5 pr-10 border ${formErrors.confirmPassword ? 'border-red-500' : 'border-gray-200'} rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300`}
                    />
                    <button
                      type="button"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2.5 border ${formErrors.phone ? 'border-red-500' : 'border-gray-200'} rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 transition-all duration-300`}
                  />
                  {formErrors.phone && <p className="text-red-500 text-xs mt-1">{formErrors.phone}</p>}
                  <p className="text-gray-400 text-xs mt-1">Exactly 11 digits, numbers only</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-5">
                  <div>
                    ...
                    <select
                      ...
                      value={formData.role}
                      onChange={handleInputChange}
                      className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#00B8DB] cursor-pointer bg-white"
                    >
                ...
                <div className="flex gap-3 justify-end mt-6">
                  <button
                    ...
                    className="px-5 py-2.5 border border-gray-200 rounded-xl text-gray-600 text-sm font-medium hover:bg-gray-50 transition-all duration-300"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-xl text-white text-sm font-medium transition-all duration-300 ${
                      actionLoading || isFormIncomplete()
                        ...
                        : 'bg-gradient-to-r from-[#00B8DB] to-[#0095b3] hover:shadow-lg hover:-translate-y-0.5'
                    }`}
                  >
                    {actionLoading ? (
              ...
              <div>
                {!isEditing ? (
                  ...
                  <div>
                    <div className="mb-4">
                      <label className="block mb-1 text-xs font-semibold text-gray-500 uppercase tracking-wide">Full Name</label>
                      <p className="px-3 py-2.5 bg-gray-50 rounded-xl text-gray-800 text-sm border border-gray-100">{selectedStaff?.name}</p>
                    </div>

                    <div className="mb-4">
                      <label className="block mb-1 text-xs font-semibold text-gray-500 uppercase tracking-wide">Email Address</label>
                      <p className="px-3 py-2.5 bg-gray-50 rounded-xl text-gray-800 text-sm border border-gray-100">{selectedStaff?.email}</p>
                    </div>

                    <div className="mb-4">
                      <label className="block mb-1 text-xs font-semibold text-gray-500 uppercase tracking-wide">Phone Number</label>
                      <p className="px-3 py-2.5 bg-gray-50 rounded-xl text-gray-800 text-sm border border-gray-100">{selectedStaff?.phone || '—'}</p>
                    </div>

                    <div className="grid grid-cols-2 gap-4 mb-5">
                      <div>
                        <label className="block mb-1 text-xs font-semibold text-gray-500 uppercase tracking-wide">Role</label>
                    ...
                    <div className="flex gap-3 justify-end mt-6">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-gradient-to-r from-[#00B8DB] to-[#0095b3] rounded-xl text-white text-sm font-medium hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
                      >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-scaleIn">
            <div className="text-center mb-5">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">{confirmationModal.title}</h3>
              <p className="text-gray-600 text-sm">{confirmationModal.message}</p>
            </div>
            <div className="flex gap-3 justify-center">
              <button
                onClick={() => setConfirmationModal({ show: false, action: '', staffMember: null, title: '', message: '' })}
                className="px-5 py-2 border border-gray-200 rounded-xl text-gray-600 text-sm font-medium hover:bg-gray-50 transition-all duration-300"
              >
                Cancel
              </button>
              <button
