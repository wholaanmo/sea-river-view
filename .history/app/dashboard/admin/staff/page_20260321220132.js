    ...
    <div className="p-8">
      ...
      <div className="flex gap-4 mb-8 flex-wrap">
        ...
        <select
          ...
          className="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-[#00B8DB] focus:ring-2 focus:ring-[#00B8DB]/20 text-gray-700 cursor-pointer min-w-37.5"
        >
                ...
                <form onSubmit={handleAddStaff}>
                  ...
                  <div className="flex gap-3 justify-end">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-linear-to-r from-cyan-500 to-cyan-600 text-white rounded-lg font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-70"
                    >
                      {actionLoading ? (
                        <span>
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 justify-end">
                        ...
                        <button
                          ...
                          className="px-6 py-2 bg-linear-to-r from-cyan-500 to-cyan-600 text-white rounded-lg font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
                        >
