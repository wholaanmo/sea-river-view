...
export default function AdminDayTour() {
  ...
  const isActivityFormIncomplete = () => {
    return !activityFormData.name.trim() || !activityFormData.pricePerHour || 
           !activityFormData.availableInventory || !activityFormData.description.trim() || !activityFormData.image;
  };
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-ocean-ice to-blue-white min-h-screen">
      ...
      {/* Activities Tab Content - Table Layout */}
      {activeTab === 'activities' && (
        <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-ocean-pale/50 border-b border-ocean-light/20">
                  ...
                  <th className="px-4 py-3 text-left text-sm font-semibold text-textPrimary">Picture</th>
                      ...
                      <td className="px-4 py-3">
                        <div className="relative w-12 h-12 rounded-lg overflow-hidden">
                          {activity.image ? (
                            ...
                            <div className="w-full h-full bg-ocean-pale flex items-center justify-center">
                              <i className="fas fa-bicycle text-ocean-light/50"></i>
                            </div>
                          )}
                        </div>
                      </td>
      ...
      {/* Tour Details Modal */}
      {showActivityDetailsModal && selectedTour && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
      ...
      {/* Activity Details Modal with Image Slider */}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-auto p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedActivity.image && (
              <div className="mb-6">
                <div className="relative overflow-hidden rounded-xl bg-ocean-pale/30" style={{ height: '400px' }}>
                  <Image
