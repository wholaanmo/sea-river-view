...
export default function AdminDayTour() {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-ocean-ice to-blue-white min-h-screen">
      ...
      {/* Activities Tab Content - Table Layout without Picture Column */}
      {activeTab === 'activities' && (
        <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
      ...
      {/* Add/Edit Activity Modal with Multiple Images */}
      {showActivityModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
          if (!actionLoading) {
            setShowActivityModal(false);
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-auto p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedActivity.images && selectedActivity.images.length > 0 && (
              <div className="mb-6">
                <div className="relative overflow-hidden rounded-xl bg-ocean-pale/30">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Image
                        ...
                        onClick={(e) => {
                          ...
                          modal.className = 'fixed inset-0 bg-black/90 z-[70] flex items-center justify-center p-4 cursor-pointer';
                          modal.onclick = () => modal.remove();
                          const img = document.createElement('img');
                          img.src = selectedActivity.images[0];
                  ...
                  {selectedActivity.images.length > 1 && (
                    <div className="flex gap-2 mt-4 overflow-x-auto pb-2">
                      {selectedActivity.images.map((img, idx) => (
                        <div key={idx} className="relative flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden cursor-pointer border-2 border-transparent hover:border-ocean-mid transition-all">
                          <Image
                            src={img}
                            alt={`Thumbnail ${idx + 1}`}
                            fill
