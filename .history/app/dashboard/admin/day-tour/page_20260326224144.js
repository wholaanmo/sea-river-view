...
const handleUpdateTour = async (e) => {
  ...
  try {
    ...
    const previousData = {
      ...
      inclusionsCount: selectedTour.inclusions?.length || 0,
      imagesCount: selectedTour.images?.length || 0
    };
    ...
    const newData = {
      ...
      maxCapacity: tourFormData.pricingType !== 'per_person' && tourFormData.maxCapacity ? parseInt(tourFormData.maxCapacity) : null,
      availability: tourFormData.availability,
      inclusionsCount: tourFormData.inclusions.length,
      imagesCount: tourFormData.images.length
    };
...
const handleUpdateActivity = async (e) => {
  ...
  try {
    ...
    const previousData = {
      ...
      imagesCount: selectedActivity.images?.length || 0
    };
    
    const newData = {
      name: activityFormData.name,
      pricePerHour: parseFloat(activityFormData.pricePerHour),
      imagesCount: activityFormData.images.length
    };
