      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border" style={{ borderColor: '#e2e8f0' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'rgba(0, 184, 219, 0.1)' }}>
              <span className="material-icons" style={{ color: '#00B8DB' }}>event</span>
            </div>
          </div>
          <div className="mt-3 flex items-center text-xs">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border" style={{ borderColor: '#e2e8f0' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'rgba(0, 184, 219, 0.1)' }}>
              <span className="material-icons" style={{ color: '#00B8DB' }}>swap_horiz</span>
            </div>
          </div>
          <div className="mt-3 flex items-center text-xs">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border" style={{ borderColor: '#e2e8f0' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'rgba(0, 184, 219, 0.1)' }}>
              <span className="material-icons" style={{ color: '#00B8DB' }}>people</span>
            </div>
          </div>
          <div className="mt-3 flex items-center text-xs">
