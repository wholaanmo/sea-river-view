      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 p-5 hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-textSecondary uppercase tracking-wide">Total Units</h3>
            <i className="fas fa-building text-ocean-light text-lg"></i>
          </div>
          <div className="text-3xl font-bold text-textPrimary">{totalUnits}</div>
          <p className="text-xs text-neutral mt-1">Total room units across all types</p>
        </div>
        
        {/* Available Rooms */}
        <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 p-5 hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-textSecondary uppercase tracking-wide">Available Rooms</h3>
            <i className="fas fa-check-circle text-green-500 text-lg"></i>
          </div>
          <div className="text-3xl font-bold text-textPrimary">{availableRooms}</div>
          <p className="text-xs text-neutral mt-1">Rooms currently available for booking</p>
        </div>
        
        {/* Under Maintenance */}
        <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 p-5 hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-textSecondary uppercase tracking-wide">Under Maintenance</h3>
            <i className="fas fa-tools text-yellow-500 text-lg"></i>
          </div>
          <div className="text-3xl font-bold text-textPrimary">{maintenanceRooms}</div>
          <p className="text-xs text-neutral mt-1">Rooms temporarily unavailable for booking</p>
        </div>
      </div>
