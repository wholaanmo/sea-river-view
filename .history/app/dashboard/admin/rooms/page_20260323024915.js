...
export default function AdminRooms() {
  ...
  const handleArchiveRoom = async (room) => {
    try {
      ...
      showNotification(`${room.name} has been archived successfully!`);
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-auto p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-semibold text-neutral uppercase tracking-wide mb-1">Room Name</label>
                <p className="text-lg font-semibold text-textPrimary">{selectedRoom.name}</p>
              </div>
              <div>
                <label className="block text-xs font-semibold text-neutral uppercase tracking-wide mb-1">Room Type</label>
                <p className="text-textPrimary">{selectedRoom.type}</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-scaleIn">
            <div className="text-center mb-5">
              ...
              <p className="text-textSecondary text-sm">
                Are you sure you want to archive "{confirmArchiveModal.room.name}"? 
