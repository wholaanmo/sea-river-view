      ...
      <div className="bg-white rounded-2xl shadow-md border border-ocean-light/10 p-6 mb-6">
        <div className="max-w-md">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by User, Role, or Module/Page..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-9 pr-10 py-2.5 border border-ocean-light/20 rounded-xl text-sm focus:outline-none focus:border-ocean-light focus:ring-2 focus:ring-ocean-light/20 transition-all duration-300"
            />
            {searchTerm && (
              <button
                onClick={clearSearch}
          ...
          <p className="text-xs text-neutral mt-2">
            Search by user name, role, or module/page
          </p>
        </div>
      </div>
