    ...
    return (
        <>
            <div className="min-h-screen w-full relative bg-gradient-to-br from-ocean-ice via-white to-ocean-pale flex items-center justify-center overflow-hidden">
                {/* New Background Design - Modern Geometric Pattern */}
                <div className="absolute inset-0 z-0">
                    {/* Large gradient orbs */}
                    <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-ocean-light/5 to-transparent blur-[100px]"></div>
                    <div className="absolute bottom-[-20%] left-[-10%] w-[550px] h-[550px] rounded-full bg-gradient-to-tr from-ocean-mid/5 to-transparent blur-[100px]"></div>
                    
                    {/* Abstract wave pattern */}
                    <svg className="absolute bottom-0 left-0 w-full h-1/3 opacity-[0.03]" preserveAspectRatio="none" viewBox="0 0 1440 320">
                        <path fill="#0B3B4F" fillOpacity="1" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,154.7C960,171,1056,181,1152,165.3C1248,149,1344,107,1392,85.3L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                    </svg>
                ...
                <div className="absolute inset-0 z-0 opacity-[0.02]" style={{
                    backgroundImage: `radial-gradient(circle at 1px 1px, #0B3B4F 1px, transparent 1px)`,
                    backgroundSize: '40px 40px'
                }}></div>

                {/* Main Container - Same Size */}
                <div className="w-[880px] max-w-[90%] h-[560px] bg-white/95 backdrop-blur-sm rounded-[40px] flex overflow-hidden shadow-2xl border border-white/40 z-10">
                    ...
                    {/* Left Panel - New Elegant Design */}
                    <div className="w-[42%] relative overflow-hidden rounded-r-[32px]">
                        {/* Background with layered design */}
                        <div className="absolute inset-0 bg-gradient-to-br from-ocean-deep via-ocean-mid to-ocean-light"></div>
                        ...
                        <div className="absolute inset-0 opacity-10" style={{
                            backgroundImage: `repeating-linear-gradient(45deg, white 0px, white 2px, transparent 2px, transparent 8px),
                                              repeating-linear-gradient(135deg, white 0px, white 2px, transparent 2px, transparent 8px)`,
                            backgroundSize: '30px 30px'
                        }}></div>
                        
                        {/* Glowing radial gradient */}
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-white/5 blur-[60px]"></div>
                        
                        {/* Decorative circles */}
                        <div className="absolute top-10 right-10 w-32 h-32 rounded-full border border-white/10"></div>
                        <div className="absolute bottom-10 left-10 w-40 h-40 rounded-full border border-white/10"></div>
                        <div className="absolute top-1/3 left-1/4 w-20 h-20 rounded-full bg-white/5 blur-xl"></div>
                        
                        <div className="relative z-10 h-full flex items-center justify-center p-8">
                            <div className="text-center max-w-[260px]">
                                {/* Logo with premium ring */}
                                <div className="mb-5 flex justify-center relative">
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[140px] h-[140px] rounded-full bg-white/10 blur-xl animate-pulse-glow"></div>
                                    <div className="relative">
                                        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-white/30 to-white/10 blur-md"></div>
