        ...
        <>
            ...
            <div className="min-h-screen w-full relative bg-linear-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-1/3 right-1/4 w-[450px] h-112.5 rounded-full bg-gradient-to-tr from-[#4FB3B3]/15 to-[#E0F2FE]/20 blur-[90px] animate-floatOrb delay-4000"></div>
