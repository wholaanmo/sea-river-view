    ...
    return (
        <>
            ...
            <div className="min-h-screen w-full relative bg-linear-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                ...
                {/* Main Container */}
                <div className="w-[840px] max-w-[90%] h-135 bg-white/95 backdrop-blur-sm rounded-[48px] flex overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-white/40 z-10">
