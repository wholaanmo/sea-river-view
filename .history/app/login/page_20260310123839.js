...
export default function Login() {
    ...
    return (
       ...
       {/* Wave Design Elements - PUT IT HERE */}
            <div className="wave-design">
                <div className="wave-svg">
                    <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <defs>
                            <clipPath id="waveClip">
                                <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25" fill="#00B8DB"></path>
                            </clipPath>
                        </defs>
                        <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".15" fill="#00B8DB"></path>
                    </svg>
                </div>
            </div>
...
<div className="left-panel">
    <div className="brand-content">
        {/* Sea & River View Title - Added above logo */}
        <div className="sea-river-title">Sea & River View</div>
        ...
        <h1 className="brand-name">Relax Where the Sea and River Meet</h1>
