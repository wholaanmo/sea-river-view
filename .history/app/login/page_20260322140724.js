        ...
        <>
            ...
            <div className="min-h-screen w-full relative bg-linear-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-[-15%] right-[-10%] w-150 h-150 rounded-full bg-linear-to-r from-[#2C7A7A]/20 to-[#4A9B9B]/15 blur-[100px] animate-floatOrb"></div>
                    ...
                    <div className="absolute top-1/3 right-1/4 w-112.5 h-112.5 rounded-full bg-linear-to-tr from-[#4FB3B3]/15 to-[#E0F2FE]/20 blur-[90px] animate-floatOrb delay-4000"></div>
                    <div className="absolute bottom-1/3 left-1/4 w-100 h-100 rounded-full bg-linear-to-bl from-[#9CA3AF]/10 to-[#2C7A7A]/15 blur-[80px] animate-floatOrb delay-6000"></div>
                </div>
                ...
                {/* Main Container */}
                <div className="w-210 max-w-[90%] h-135 bg-white/95 backdrop-blur-sm rounded-[48px] flex overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-white/40 z-10">
                    
                    {/* Left Panel - Ocean Gradient */}
                    <div className="w-[45%] bg-linear-to-br from-[#0B3B4F] via-[#146B6B] to-[#2C9B9B] p-6 flex items-center justify-center relative overflow-hidden rounded-r-[40px]">
                        {/* Animated gradient overlay */}
                        <div className="absolute inset-0 bg-linear-to-tr from-[#4FB3B3]/30 via-transparent to-[#E0F2FE]/20 animate-gradientShift"></div>
                        {/* Shimmer effect overlay */}
                        <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/10 to-transparent -skew-x-12 animate-shimmer"></div>
                        
                        <div className="text-center max-w-65 relative z-10">
                            {/* Logo Container */}
                            <div className="mb-4 flex justify-center relative">
                                <div className="w-27.5 h-27.5 rounded-full bg-linear-to-br from-[#6DC5C5] via-[#4A9B9B] to-[#2C7A7A] p-0.75 relative z-10 shadow-2xl ring-4 ring-white/30">
                                    <div className="w-full h-full rounded-full overflow-hidden bg-linear-to-br from-[#0B3B4F] to-[#1B5E6B] shadow-inner">
                                        <Image 
                            ...
                            <div className="mb-2">
                                <h2 className="font-playfair text-2xl font-bold tracking-wide">
                                    <span className="bg-linear-to-r from-white via-[#E0F2FE] to-white bg-clip-text text-transparent drop-shadow-lg">
                                        SandyFeet
                                    </span>
                                    <br />
                            ...
                            <p className="text-white/90 font-poppins text-xs mb-8 max-w-60 mx-auto italic">
                            ...
                            <div className="flex justify-center gap-6">
                                {[
                                    ...
                                    <div key={idx} className="flex flex-col items-center gap-1.5">
                                        <div className="w-10.5 h-10.5 rounded-full bg-linear-to-br from-white/25 to-white/10 backdrop-blur-sm flex items-center justify-center border border-white/40 shadow-md">
                            ...
                            {/* Decorative Waves */}
                            <div className="absolute bottom-0 left-0 w-full h-12.5 overflow-hidden pointer-events-none">
                                <div className="absolute bottom-0 left-0 w-[200%] h-full bg-linear-to-t from-white/20 via-white/10 to-transparent rounded-t-full animate-wave"></div>
                                <div className="absolute -bottom-2 left-0 w-[200%] h-full bg-linear-to-t from-white/10 via-transparent to-transparent rounded-t-full animate-wave-reverse"></div>
                            </div>
                        </div>
                    </div>
                    
                    {/* Right Panel */}
                    <div className="w-[55%] p-8 flex items-center justify-center bg-linear-to-br from-white via-[#FEFEFE] to-[#F8FDFF] overflow-y-auto no-scrollbar">
                        <div className="w-full max-w-75 login-box">
                            {/* Header */}
                            <div className="text-center mb-6">
                                <h1 className="font-playfair text-2xl font-bold bg-linear-to-r from-[#0B3B4F] to-[#2C7A7A] bg-clip-text text-transparent mb-1">Welcome Back</h1>
                                <p className="font-poppins text-xs text-[#2C7A7A]/80">Sign in to your account</p>
                            </div>
                            
                            {/* Error Message */}
                            {error && (
                                <div className="bg-linear-to-r from-red-50 to-red-100/50 rounded-xl p-3 mb-4 flex items-center gap-2 shadow-sm">
                                ...
                                <div className="mb-3">
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-9 pr-3 py-2.5 bg-linear-to-r from-[#F0F9FF]/50 to-white border border-[#2C7A7A]/20 rounded-xl text-[#0B3B4F] font-poppins text-sm placeholder:text-[#2C7A7A]/40 focus:outline-none focus:border-[#2C7A7A] focus:ring-2 focus:ring-[#2C7A7A]/30 transition-all duration-300 shadow-sm"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="mb-4">
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-9 pr-10 py-2.5 bg-linear-to-r from-[#F0F9FF]/50 to-white border border-[#2C7A7A]/20 rounded-xl text-[#0B3B4F] font-poppins text-sm placeholder:text-[#2C7A7A]/40 focus:outline-none focus:border-[#2C7A7A] focus:ring-2 focus:ring-[#2C7A7A]/30 transition-all duration-300 shadow-sm"
                                        />
                                        <button 
                                            type="button"
            ...
            {showForgotModal && (
                <div className="fixed inset-0 bg-linear-to-br from-black/60 to-black/40 backdrop-blur-md z-100 flex items-center justify-center p-4 animate-fadeIn" onClick={() => setShowForgotModal(false)}>
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-slideUp border border-white/20" onClick={(e) => e.stopPropagation()}>
                        <div className="bg-linear-to-r from-[#0B3B4F] via-[#1B5E6B] to-[#2C7A7A] p-5 rounded-t-2xl flex items-center justify-between relative overflow-hidden">
                        ...
                        <div className="p-6">
                            ...
                            {resetMessage && (
                                <div className="bg-linear-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 rounded-lg p-3 mb-4 flex items-center gap-2">
                            ...
                            {resetError && (
                                <div className="bg-linear-to-r from-red-50 to-rose-50 border-l-4 border-red-400 rounded-lg p-3 mb-4 flex items-center gap-2">
                                    <i className="fas fa-exclamation-circle text-red-500 text-sm"></i>
                            ...
                            <form onSubmit={handleResetPassword}>
                                <div className="relative mb-5 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-9 pr-3 py-3 bg-linear-to-r from-[#F0F9FF]/50 to-white border border-[#2C7A7A]/20 rounded-xl text-[#0B3B4F] font-poppins text-sm placeholder:text-[#2C7A7A]/40 focus:outline-none focus:border-[#2C7A7A] focus:ring-2 focus:ring-[#2C7A7A]/20 transition-all duration-300"
                                    />
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 py-2 rounded-xl bg-linear-to-r from-[#1B5E6B] to-[#4A9B9B] text-white font-poppins text-sm font-medium hover:shadow-lg transition-all duration-300 disabled:opacity-50"
                                        disabled={resetLoading || resetMessage}
                                    >
                                        {resetLoading ? (
                                            <>
