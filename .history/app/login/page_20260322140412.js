        ...
        <>
            ...
            <div className="min-h-screen w-full relative bg-linear-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute top-1/3 right-1/4 w-112.5 h-112.5 rounded-full bg-gradient-to-tr from-[#4FB3B3]/15 to-[#E0F2FE]/20 blur-[90px] animate-floatOrb delay-4000"></div>
                    <div className="absolute bottom-1/3 left-1/4 w-100 h-[400px] rounded-full bg-linear-to-bl from-[#9CA3AF]/10 to-[#2C7A7A]/15 blur-[80px] animate-floatOrb delay-6000"></div>
                </div>
