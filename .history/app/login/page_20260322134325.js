...
export default function Login() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen w-full relative bg-gradient-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                {/* Animated gradient orbs with lighter tones */}
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-[-15%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-r from-[#2C7A7A]/20 to-[#4A9B9B]/15 blur-[100px] animate-floatOrb"></div>
                    <div className="absolute bottom-[-15%] left-[-10%] w-[550px] h-[550px] rounded-full bg-gradient-to-l from-[#0B3B4F]/15 to-[#1B5E6B]/15 blur-[100px] animate-floatOrb delay-2000"></div>
                    ...
                    <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-bl from-[#9CA3AF]/10 to-[#2C7A7A]/15 blur-[80px] animate-floatOrb delay-6000"></div>
                </div>
