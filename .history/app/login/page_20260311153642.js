...
export default function Login() {
   ...
   const loginUser = async (e) => {
    ...
    try {
        ...
        if (role !== userType) {
            setError(`This account is registered as ${role}. Please select the correct user type.`);
    ...
    <div className={`slider-background ${userType === 'staff' ? 'staff-active' : 'admin-active'}`}></div>
    <button
        type="button"
        className={`user-type-btn light-btn enhanced-btn ${userType === 'staff' ? 'enhanced-active' : ''}`}
    ...
    <button
        type="button"
        className={`user-type-btn light-btn enhanced-btn ${userType === 'admin' ? 'enhanced-active' : ''}`}
        ...
        Admin
                            ...
                            <form onSubmit={loginUser}>
                                ...
                                <div className="input-group light-input-group enhanced-input-group">
                                    ...
                                    >
                                        <i className={`fas ${showPassword ? 'fa-eye-slash' : 'fa-eyefa-eye-slash'}`}></i>
                                    </button>
                                </div>
                            ...
                            <div className="login-footer light-footer enhanced-footer">
                                <p>© 2026 Sea & River View Resort</p>
                            </div>
                        </div>
                    </div>
                </div>
