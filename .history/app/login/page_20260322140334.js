        ...
        <>
            ...
            <div className="min-h-screen w-full relative bg-linear-to-br from-[#F0F7FF] via-[#F5FAFF] to-[#FAFDFF] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute bottom-[-15%] left-[-10%] w-137.5 h-137.5 rounded-full bg-gradient-to-l from-[#0B3B4F]/15 to-[#1B5E6B]/15 blur-[100px] animate-floatOrb delay-2000"></div>
