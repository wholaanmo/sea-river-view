...
export default function Login() {
    ...
    const [isClient, setIsClient] = useState(false); // Add this for hydration safety
    ...
    useEffect(() => {
        ...
        // Animation code - now safely runs only on client
    ...
    // Prevent rendering until we're on the client to avoid hydration mismatch
    if (!isClient) {
    ...
    return (
        <>
            <Head>
                ...
                {/* Add this meta tag to prevent iOS auto-link detection */}
