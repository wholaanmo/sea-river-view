...
export default function Login() {
    ...
    const [userType, setUserType] = useState('staff'); // 'admin' or 'staff'
        ...
        <>
            <div className="min-h-screen w-full relative bg-gradient-to-br from-ocean-ice via-white to-ocean-pale flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-ocean-light/20 blur-[80px]"></div>
                    <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-ocean-deep/15 blur-[80px]"></div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-ocean-lighter/10 blur-[80px]"></div>
                </div>
                ...
                {/* Main Container */}
                <div className="w-[900px] max-w-[90%] h-[520px] bg-white rounded-[40px] flex overflow-hidden shadow-2xl border border-white/40 z-10">
                    
                    {/* Left Panel - Dark Ocean Theme */}
                    <div className="w-[45%] bg-gradient-to-br from-ocean-deep via-ocean-mid to-ocean-light p-8 flex items-center justify-center relative overflow-hidden rounded-r-[30px]">
                        ...
                        <div className="text-center max-w-[280px] relative z-10">
                            ...
                            <div className="mb-4 flex justify-center relative">
                                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[150px] h-[150px] bg-ocean-lighter/30 rounded-full animate-pulse-glow"></div>
                            ...
                            {/* Sea & River View Title */}
                            <div className="text-white font-playfair text-xl font-bold tracking-wider mb-2">
                                SandyFeet
                            </div>
                            
                            {/* Tagline */}
                            <div className="text-white/80 font-poppins text-xs font-light mb-6 max-w-[240px] mx-auto leading-relaxed">
                            ...
                            <div className="flex justify-center gap-5">
                                <div className="flex flex-col items-center gap-2 group">
                                    <div className="w-[44px] h-[44px] rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/30 shadow-md group-hover:bg-white/20 transition-all duration-300">
                                        <i className="fas fa-umbrella-beach text-white text-lg"></i>
                                    </div>
                                    <span className="text-white/80 text-[11px] font-medium">Rooms & Camping</span>
                                </div>
                                <div className="flex flex-col items-center gap-2 group">
                                    <div className="w-[44px] h-[44px] rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/30 shadow-md group-hover:bg-white/20 transition-all duration-300">
                                        <i className="fas fa-sun text-white text-lg"></i>
                                    </div>
                                    <span className="text-white/80 text-[11px] font-medium">Day Tour</span>
                                </div>
                                <div className="flex flex-col items-center gap-2 group">
                                    <div className="w-[44px] h-[44px] rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/30 shadow-md group-hover:bg-white/20 transition-all duration-300">
                                        <i className="fas fa-water text-white text-lg"></i>
                                    </div>
                                    <span className="text-white/80 text-[11px] font-medium">Beach Access</span>
                                </div>
                            </div>
                    ...
                    <div className="w-[55%] p-10 flex items-center justify-center bg-white overflow-y-auto no-scrollbar">
                        <div className="w-full max-w-[320px] login-box">
                            ...
                            <div className="relative mb-6">
                                <div className="flex bg-ocean-ice/50 rounded-full p-1">
                                    <button
                                        type="button"
                                        ...
                                        className={`flex-1 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                                            userType === 'staff' 
                                                ...
                                                : 'text-ocean-mid hover:text-ocean-light'
                                        }`}
                                    >
                                        Staff
                                    </button>
                            ...
                            {error && (
                                <div className="bg-red-50 border-l-4 border-red-400 rounded-lg p-3 mb-5 flex items-center gap-2">
                            ...
                            <form onSubmit={loginUser}>
                                ...
                                <div className="mb-4">
                                    <div className="relative group">
                                        <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-ocean-light/40 group-focus-within:text-ocean-light">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-10 pr-3 py-3 bg-ocean-ice/20 border border-ocean-light/20 rounded-xl text-ocean-deep font-poppins text-sm placeholder:text-ocean-light/40 focus:outline-none focus:border-ocean-light focus:ring-2 focus:ring-ocean-light/20 focus:bg-white transition-all duration-300"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="mb-5">
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-10 pr-10 py-3 bg-ocean-ice/20 border border-ocean-light/20 rounded-xl text-ocean-deep font-poppins text-sm placeholder:text-ocean-light/40 focus:outline-none focus:border-ocean-light focus:ring-2 focus:ring-ocean-light/20 focus:bg-white transition-all duration-300"
                                        />
                                        <button 
                                            type="button"
                                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-ocean-light/40 hover:text-ocean-light"
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-fadeIn" onClick={() => setShowForgotModal(false)}>
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-slideUp" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-6">
                            ...
                            {resetMessage && (
                                <div className="bg-green-50 border-l-4 border-green-400 rounded-lg p-3 mb-4 flex items-center gap-2">
                            ...
                            {resetError && (
                                <div className="bg-red-50 border-l-4 border-red-400 rounded-lg p-3 mb-4 flex items-center gap-2">
                                    <i className="fas fa-exclamation-circle text-red-500 text-sm"></i>
                            ...
                            <form onSubmit={handleResetPassword}>
                                <div className="relative mb-5">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-3 py-3 bg-ocean-ice/20 border border-ocean-light/20 rounded-xl text-ocean-deep font-poppins text-sm placeholder:text-ocean-light/40 focus:outline-none focus:border-ocean-light focus:ring-2 focus:ring-ocean-light/20 transition-all duration-300"
                                    />
                                </div>
