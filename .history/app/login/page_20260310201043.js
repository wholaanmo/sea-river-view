...
export default function Login() {
    ...
    // Staff credentials (for demo purposes)
    const STAFF_EMAIL = 'staff@seariverview.com';
    ...
    const loginUser = async (e) => {
        ...
        try {
            if (userType === 'admin') {
                ...
                // Check for demo staff credentials first
                ...
                <div className="container smaller-container">
                    ...
                    <div className="right-panel light-bg enhanced no-scrollbar">
                        <div className="login-box enhanced-login-box smaller-box">
                            ...
                            <div className="staff-note light-staff-note enhanced-staff-note">
                                <i className="fas fa-info-circle"></i>
                                <span>
                                    {userType === 'admin' 
                                        ? 'Admin: admin@seariverview.com / Admin@123' 
                                        : 'Staff: staff@seariverview.com / Staff@123'}
                                </span>
                            </div>
