                    ...
                    <div className="w-[45%] bg-linear-to-br from-[#0B3B4F] via-[#146B6B] to-[#2C9B9B] p-6 flex items-center justify-center relative overflow-hidden rounded-r-[40px]">
                        ...
                        <div className="text-center max-w-65 relative z-10">
                            ...
                            <div className="absolute bottom-0 left-0 w-full h-12.5 overflow-hidden pointer-events-none">
                                ...
                                <div className="absolute bottom-[-8px] left-0 w-[200%] h-full bg-linear-to-t from-white/10 via-transparent to-transparent rounded-t-full animate-wave-reverse"></div>
                            </div>
                        </div>
                    </div>
