                            ...
                            <div className="flex justify-center gap-6">
                                {[
                                    ...
                                    <div key={idx} className="flex flex-col items-center gap-1.5">
                                        <div className="w-10.5 h-[42px] rounded-full bg-linear-to-br from-white/25 to-white/10 backdrop-blur-sm flex items-center justify-center border border-white/40 shadow-md">
