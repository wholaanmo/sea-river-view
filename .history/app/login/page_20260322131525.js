...
export default function Login() {
    ...
    return (
        <>
            <div className="min-h-screen w-full relative bg-gradient-to-br from-[#E6F4FA] via-[#D9EAF5] to-[#C5E0F0] flex items-center justify-center overflow-hidden">
                {/* Enhanced animated gradient orbs with richer colors */}
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-[-15%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-r from-[#2C7A7A]/30 to-[#4A9B9B]/20 blur-[100px] animate-floatOrb"></div>
                    <div className="absolute bottom-[-15%] left-[-10%] w-[550px] h-[550px] rounded-full bg-gradient-to-l from-[#0B3B4F]/25 to-[#1B5E6B]/20 blur-[100px] animate-floatOrb delay-2000"></div>
                    <div className="absolute top-1/3 right-1/4 w-[450px] h-[450px] rounded-full bg-gradient-to-tr from-[#4FB3B3]/20 to-[#E0F2FE]/30 blur-[90px] animate-floatOrb delay-4000"></div>
                    <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] rounded-full bg-gradient-to-bl from-[#9CA3AF]/15 to-[#2C7A7A]/20 blur-[80px] animate-floatOrb delay-6000"></div>
                </div>
                
                {/* Enhanced pattern overlay with shimmer */}
                <div className="absolute inset-0 z-0 opacity-20" style={{
                    backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0 L30 60 M0 30 L60 30' stroke='rgba(43, 108, 108, 0.15)' stroke-width='1' fill='none'/%3E%3Ccircle cx='30' cy='30' r='2' fill='rgba(43, 108, 108, 0.2)'/%3E%3C/svg%3E")`,
                    backgroundSize: '40px 40px'
                }}></div>

                {/* Main Container - Enhanced with glass morphism */}
                <div className="w-[920px] max-w-[92%] h-[580px] bg-white/95 backdrop-blur-sm rounded-[48px] flex overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-white/40 z-10 transition-all duration-500 hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]">
                    
                    {/* Left Panel - Enhanced Ocean Gradient with animated shine */}
                    <div className="w-[45%] bg-gradient-to-br from-[#0B3B4F] via-[#146B6B] to-[#2C9B9B] p-8 flex items-center justify-center relative overflow-hidden rounded-r-[40px]">
                        ...
                        <div className="text-center max-w-[280px] relative z-10">
                            {/* Logo Container - Enhanced glow */}
                            <div className="mb-4 flex justify-center relative">
                                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[170px] h-[170px] bg-gradient-to-r from-[#4FB3B3]/50 to-[#E0F2FE]/40 rounded-full animate-pulse-glow blur-md"></div>
                                <div className="w-[130px] h-[130px] rounded-full bg-gradient-to-br from-[#6DC5C5] via-[#4A9B9B] to-[#2C7A7A] p-[3px] relative z-10 shadow-2xl ring-4 ring-white/30">
                            ...
                            {/* Title - Enhanced gradient text */}
                            <div className="text-white font-playfair text-2xl font-bold tracking-wider mb-2 px-5 py-1.5 bg-gradient-to-r from-transparent via-white/25 to-transparent rounded-full inline-block backdrop-blur-sm shadow-lg">
                                SandyFeet Reservation
                            </div>
                            
                            {/* Tagline - Enhanced with subtle glow */}
                            <p className="text-white/95 font-poppins text-sm mb-8 max-w-[260px] mx-auto italic drop-shadow-md">
                                Plan Your SandyFeet Escape with Ease
                            </p>
                            
                            {/* Features - Enhanced with glow effects */}
                            <div className="flex justify-center gap-8">
                                {[
                                    ...
                                    <div key={idx} className="flex flex-col items-center gap-2 group cursor-pointer">
                                        <div className="w-[48px] h-[48px] rounded-full bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-sm flex items-center justify-center border border-white/50 shadow-lg group-hover:bg-white/40 group-hover:scale-110 transition-all duration-300 group-hover:shadow-xl">
                                            <i className={`fas ${feature.icon} text-white text-xl drop-shadow`}></i>
                                        </div>
                                        <span className="text-white text-xs font-medium tracking-wide group-hover:tracking-wider transition-all">{feature.label}</span>
                                    </div>
                                ))}
                            </div>
                            
                            {/* Decorative Waves - Enhanced */}
                            <div className="absolute bottom-0 left-0 w-full h-[60px] overflow-hidden pointer-events-none">
                    ...
                    {/* Right Panel - Enhanced with subtle gradient background */}
                    <div className="w-[55%] p-10 flex items-center justify-center bg-gradient-to-br from-white via-[#FEFEFE] to-[#F8FDFF] overflow-y-auto no-scrollbar">
                        <div className="w-full max-w-[330px] login-box">
                            {/* Header - Enhanced with gradient text */}
                            <div className="text-center mb-8">
                                <h1 className="font-playfair text-3xl font-bold bg-gradient-to-r from-[#0B3B4F] to-[#2C7A7A] bg-clip-text text-transparent mb-2">Welcome Back</h1>
                                <p className="font-poppins text-sm text-[#2C7A7A]/80">Sign in to your account</p>
                            </div>
                            
                            {/* Enhanced Error Message */}
                            {error && (
                                <div className="bg-gradient-to-r from-red-50 to-red-100/50 border-l-4 border-red-400 rounded-xl p-3 mb-5 flex items-center gap-2 shadow-sm">
                            ...
                            <form onSubmit={loginUser}>
                                ...
                                <div className="mb-4">
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-9 pr-3 py-3 bg-gradient-to-r from-[#F0F9FF]/50 to-white border border-[#2C7A7A]/20 rounded-xl text-[#0B3B4F] font-poppins text-sm placeholder:text-[#2C7A7A]/40 focus:outline-none focus:border-[#2C7A7A] focus:ring-2 focus:ring-[#2C7A7A]/30 transition-all duration-300 shadow-sm hover:shadow-md"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="mb-5">
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            disabled={loading}
                                            className="w-full pl-9 pr-10 py-3 bg-gradient-to-r from-[#F0F9FF]/50 to-white border border-[#2C7A7A]/20 rounded-xl text-[#0B3B4F] font-poppins text-sm placeholder:text-[#2C7A7A]/40 focus:outline-none focus:border-[#2C7A7A] focus:ring-2 focus:ring-[#2C7A7A]/30 transition-all duration-300 shadow-sm hover:shadow-md"
                                        />
                                        <button 
                                            type="button"
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    <label className="flex items-center gap-2 cursor-pointer group">
                                        <input 
                                            ...
                                            className="w-4 h-4 accent-[#2C7A7A] rounded cursor-pointer shadow-sm"
                                        />
                                ...
                                {/* Enhanced Sign In Button with gradient animation */}
                                <button 
                                    type="submit" 
                                    className="w-full py-3 bg-gradient-to-r from-[#1B5E6B] via-[#2C7A7A] to-[#4A9B9B] bg-[length:200%_auto] text-white font-poppins font-semibold text-sm rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed animate-gradientShift"
                                    disabled={loading}
                                >
                                    {loading ? (
                            ...
                            {/* Enhanced Footer */}
                            <div className="text-center mt-8 pt-4 border-t border-[#2C7A7A]/10">
