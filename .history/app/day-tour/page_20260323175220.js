          ...
          <div className="flex flex-col lg:flex-row gap-5">
            ...
            <div className="lg:w-[30%] space-y-4">
              ...
              {activities.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm border border-ocean-light/10 p-4">
                  ...
                  <div className="relative mb-3">
                    <i className="fas fa-search absolute left-3 top-1/2 -translate-y-1/2 text-ocean-light/40 text-xs"></i>
                    <input
                      type="text"
                      placeholder="Search activities..."
                      value={activitySearchTerm}
                      onChange={(e) => setActivitySearchTerm(e.target.value)}
                      className="w-full pl-8 pr-3 py-1.5 border border-ocean-light/20 rounded-lg text-sm placeholder:text-textSecondary/50 focus:outline-none focus:border-ocean-light focus:ring-1 focus:ring-ocean-light/20 transition-all duration-300 bg-white"
                    />
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-ocean-light/10 p-4">
                ...
                {tourTypes.length > 0 && (
                  <div className="mt-4">
                    <h4 className="text-xs font-semibold text-textSecondary uppercase tracking-wide mb-2">Tour Types</h4>
