      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ 
            ...
            <i className="fas fa-user-tie" style={{ fontSize: '0.75rem', color: '#00B8DB', marginRight: '0.25rem' }}></i>
            <span style={{ fontSize: '0.75rem', fontWeight: '500', color: 'white' }}>Staff</span>
          </div>
