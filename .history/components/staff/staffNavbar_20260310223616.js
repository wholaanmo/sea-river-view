  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          {/* Staff Badge - White background with dark text */}
          <div style={{
            display: 'flex',
            alignItems: 'center',
            gap: '0.5rem',
            ...
            <i className="fas fa-user-tie" style={{ color: '#0F172B', fontSize: '1rem' }}></i>
            <span style={{ fontSize: '0.875rem', fontWeight: '600', color: '#0F172B' }}>Staff</span>
          </div>
