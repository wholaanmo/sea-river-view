          ...
          {!is_expanded && (
            <div style={{ 
              ...
              <div style={{
                ...
                <i className="fas fa-user-tie" style={{ fontSize: '1.25rem', color: '#00B8DB' }}></i>
              </div>
            </div>
          )}
          ...
          {is_expanded && (
            <div style={{ width: '100%', marginBottom: '1rem', padding: '0 0.5rem' }}>
              <div style={{
                ...
                <i className="fas fa-user-tie" style={{ color: '#00B8DB', fontSize: '1.25rem' }}></i>
