...
export default function AdminSidebar({ isOpen, onToggle }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-[60px] h-[calc(100vh-60px)] bg-[#ECF9FC] z-50 overflow-y-auto transition-all duration-300 flex flex-col ${
      ...
      >
        <div className="p-4 flex-1">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <span className={`material-icons text-2xl min-w-[24px] text-center ${
        ...
        <div className="p-4 border-t border-[#5FB3C8]/30">
          ...
          >
            <span className="material-icons text-2xl min-w-[24px] text-center text-[#2F6F7E]">
              logout
            </span>
            {is_expanded && (
      ...
      {showSignOutModal && (
        ...
        >
          <div
            className="bg-white rounded-[40px] w-full max-w-[400px] p-6 shadow-xl"
          ...
          >
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg bg-gradient-to-r from-[#2F6F7E] to-[#5FB3C8] text-white hover:opacity-90 transition-all duration-300"
              >
                Sign Out
              </button>
            </div>
