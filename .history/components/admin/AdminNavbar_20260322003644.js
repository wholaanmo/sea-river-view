...
export default function AdminNavbar({ toggleSidebar }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-15 bg-main z-50 shadow-md flex items-center">
      <div className="flex items-center justify-between h-full px-4 w-full">
        ...
        <div className="flex items-center gap-3">
          {/* Role and Name Badge */}
          <div className="flex items-center gap-2 px-5 py-2 rounded-full bg-white shadow-sm border border-neutral/20">
