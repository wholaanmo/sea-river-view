...
export default function AdminSidebar({ isOpen, onToggle }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
className={`fixed left-0 top-15 h-[calc(100vh-3.75rem)] bg-main z-50 overflow-y-auto transition-all duration-300 flex flex-col ${is_expanded ? 'w-57.5' : 'w-18'} ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}
      >
