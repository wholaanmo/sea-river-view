    ...
    >
      <div className="flex items-center justify-between h-full px-6 w-full">
        ...
        <div className="flex items-center gap-4">
          {/* Role and Name Badge */}
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-ocean-pale to-white shadow-sm border border-ocean-light/20 hover:shadow-md transition-all duration-200">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-ocean-pale to-white text-ocean-light border border-ocean-light/20 hover:bg-gradient-to-r hover:from-ocean-light hover:to-ocean-mid hover:text-white transition-all duration-300 hover:rotate-180 shadow-sm"
          >
