...
export default function AdminSidebar({ isOpen, onToggle }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-navbar h-[calc(100vh-60px)] bg-main z-50 overflow-y-auto transition-all duration-300 flex flex-col shadow-lg ${
          ...
          >
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                style={{
                  background: 'linear-gradient(135deg, #2F6F7E, #5FB3C8)',
                  border: 'none'
                }}
              >
                Sign Out
