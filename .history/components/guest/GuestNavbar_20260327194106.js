...
import CartButton from '@/components/guest/CartButton'; // Import CartButton
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-ocean-deep/85 via-ocean-mid/85 to-ocean-deep/85 backdrop-blur-md shadow-lg transition-all duration-500">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="flex justify-between items-center h-16 md:h-20">
              ...
              {/* Cart button placeholder during loading */}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-6 lg:gap-8" ref={navRef}>
            ...
            {/* Right side - Cart button and mobile menu button */}
            <div className="flex items-center gap-3">
              {/* Cart Button - Desktop */}
          ...
          <div className="mt-6 pt-4 border-t border-white/20">
            <div className="px-4 py-2">
              <div className="flex items-center justify-between">
                <span className="text-white/80 text-sm font-medium">Your Cart</span>
                <CartButton />
              </div>
            </div>
          </div>
