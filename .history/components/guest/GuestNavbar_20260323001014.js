...
export default function GuestNavbar() {
  ...
  const navLinks = [
    ...
    { href: '/app/day-tour', label: 'Day Tour' },
    { href: '/app/reservation-tracker', label: 'Reservation Tracker' },
      ...
      <nav className="bg-gradient-to-r from-ocean-deep to-ocean-mid shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            {/* Logo and Site Name */}
            <Link href="/app/home" className="flex items-center gap-3 group" onClick={closeMobileMenu}>
