        ...
        <div className="p-6">
          ...
          <div className="mt-2 space-y-1">
            <p className="text-lg font-bold text-ocean-mid">
              Adult (16+): ₱{tour.adultPrice?.toLocaleString()}
            </p>
            <p className="text-lg font-bold text-ocean-mid">
              Kid (15-): ₱{tour.kidPrice?.toLocaleString()}
              <span className="text-sm font-normal text-textSecondary ml-1">{getPriceSuffix()}</span>
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-auto p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-ocean-mid">₱{tour.adultPrice?.toLocaleString()}</p>
              </div>
              <div>
                <label className="block text-xs font-semibold text-neutral uppercase tracking-wide mb-1">Kid Price (15-)</label>
                <p className="text-2xl font-bold text-ocean-mid">₱{tour.kidPrice?.toLocaleString()}</p>
                <span className="text-xs text-neutral">{getPriceSuffix()}</span>
              </div>
              {tour.maxCapacity && tour.pricingType !== 'per_person' && (
                <div>
