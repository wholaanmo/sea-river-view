// components/guest/RoomCard.js (updated)
'use client';
...
import MultiBookingModal from './MultiBookingModal';
    ...
    <>
      <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
        ...
        <div className="p-6">
          ...
          {/* Buttons - Updated with Add to Cart */}
          ...
          <button
            ...
            className="w-full mt-2 px-4 py-2 border-2 border-ocean-light/30 text-ocean-mid rounded-xl font-medium hover:bg-ocean-ice transition-all duration-300 flex items-center justify-center gap-2"
          >
